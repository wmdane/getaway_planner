function getCity(cityValue, stateValue) {
  var cityInput = cityValue;
  var stateInput = stateValue;
  var queryURL2 =
    "https://developers.zomato.com/api/v2.1/cities?q=" +
    cityInput +
    "&apikey=f2f17d46cbed2f06723d01c2bf241ca1";
  $.ajax({
    url: queryURL2,
    method: "GET",
    ...
    function searchZomato() {
      var cityCode = cityID;
      var queryURL =
        "https://developers.zomato.com/api/v2.1/search?apikey=f2f17d46cbed2f06723d01c2bf241ca1&entity_id=" +
        cityCode +
